    ...
    <div class="box">
      ...
      <div class="form-container">
        ...
        <form method="POST" action="{{ route('aes.decrypt') }}">
            @csrf
          <div class="user-box">
            <input type="text" name="ciphertext" id="ciphertext" rows="6" cols="50" value=" @if(isset($ciphertext))
            {{ $ciphertext }}
        @endif" required><br>
   ...
   <div class="item-hints">
    <div class="hint" data-position="4">
      ...
      <div class="hint-content do--split-children">
        <p>AES, which stands for Advanced Encryption Standard, is a symmetric block cipher algorithm widely used for secure data encryption. It operates on fixed-size blocks of data and employs a substitution-permutation network.
        </p>
        </div>
    </div>
  </div>

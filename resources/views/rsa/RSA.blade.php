...
<body>
    ...
    <div class="box">
        <h2>Encryption</h2>
        <form method="POST" action="{{ route('rsa.encrypt') }}">
            @csrf
            <div class="user-box">
              ...
              <br>
              @if(isset($encodedCiphertext))
    <h2>Encrypted Text:</h2>
    <p>{{ $encodedCiphertext }}</p>
@endif
              <center>
              <button type="submit">
                Encrypt
      ...
      <div class="form-container">
        <h2>Decryption</h2>
        <form method="POST" action="{{ route('rsa.decrypt') }}">
            @csrf
          <div class="user-box">
   ...
   <div class="item-hints">
    <div class="hint" data-position="4">
      ...
      <div class="hint-content do--split-children">
        <p>The RSA algorithm is a widely-used asymmetric encryption algorithm that relies on the use of a public key for encryption and a private key for decryption. It provides a secure method for transmitting data and verifying the authenticity of the sender.</p>
        {{-- <p>To encrypt data using RSA, the plaintext is encrypted with the recipient's public key, which can be freely shared. The encrypted data, or ciphertext, can only be decrypted using the recipient's private key.</p> --}}
        {{-- <p>By using RSA, sensitive information can be securely transmitted over untrusted networks, ensuring confidentiality and integrity.</p> --}}
